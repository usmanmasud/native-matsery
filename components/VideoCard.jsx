...
const VideoCard = ({ video: { title, thumbnail, video, creator: { username, avatar } } }) => {
    ...
    return (
        <View className="flex-col items-center px-4 mb-14">
            ...
            {play ? (
                <Video source={{ uri: video }} className="w-full h-60 rounded-xl mt-3 bg-white/10" resizeMode={ResizeMode.CONTAIN} useNativeControls shouldPlay onPlaybackStatusUpdate={(status) => {
