...
const Create = () => {
    ...
    const submit = async () => {
        if (!form.prompt || form.title || form.thumbnail || form.video) {
            return Alert.alert('Please Fill All Values')
        }
        setUploading(true);
    ...
    return (
        <SafeAreaView className="bg-primary h-full">
            <ScrollView className="px-4 my-6">
                ...
                <FormField title="Video Title" value={form.title} placeholder="Give a title" handleChangeText={(e) => setForm({ ...form, title: e })} otherStyles="mt-10" />
                ...
                <FormField title="AI Prompt" value={form.prompt} placeholder="prompt used to create  video" handleChangeText={(e) => setForm({ ...form, prompt: e })} otherStyles="mt-7" />
